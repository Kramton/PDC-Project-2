...
//    public void useItem(PlayerPanel player, int itemIndex) {
    public void useItem(PlayerPanel player, ItemPanel item) {
...
//        }
       ...
       // itemIndex--;
//        if(player.getName().equals("Potion")) {
//            player.changeHealth(79);
//        }
//        else if(player.getName().equals("Shield")) {
//            player.changeDefense(10);
//        }
//        else if(player.getName().equals("Sword")) {
//            player.changeAttack(10);
//        }
